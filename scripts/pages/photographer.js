class PhotographerApp {
    ...
    async main() {
        ...
        let photographer = this.getPhotographer(photographers);
        this.displayProfile(photographer);

        // on récupère les medias du photographe depuis le photographeId
        
        this.getMediasOfPhotographer(media);
        console.log('scope', this.allMedias)
        this.displayMedias(photographer)
        this.createLighbox(photographer)
    ...
    displayMedias(photographer) {
        ...
        //         $media_content,
        //         $name
        //     } = this.createMediaCard(media, photographer);

        //     this.createMediaInLightBox($media_content, $name);
